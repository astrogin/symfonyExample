...
use App\MwsClients\Feed\Types\SubmitFeed\Info;
...
class Result extends Base
{
    ...
    public function __construct($data = null)
    {
        ...
        'FeedSubmissionInfo' => array('FieldValue' => array(), 'FieldType' => array(Info::class)),
        );
     ...
     * 
     * @param Info  $feedSubmissionInfoArgs one or more FeedSubmissionInfo
     * @return $this  instance
     */
