...
use App\MwsClients\Feed\Types\StatusList;
use App\MwsClients\Feed\Types\TypeList;
...
class Request extends Base
{
    ...
    public function __construct($data = null)
    {
        ...
        'FeedSubmissionIdList' => array('FieldValue' => null, 'FieldType' => IdList::class),
        'MaxCount' => array('FieldValue' => null, 'FieldType' => 'string'),
        'FeedTypeList' => array('FieldValue' => null, 'FieldType' => TypeList::class),
        'FeedProcessingStatusList' => array('FieldValue' => null, 'FieldType' => StatusList::class),
