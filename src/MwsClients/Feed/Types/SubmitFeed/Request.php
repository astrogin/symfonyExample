...
use App\MwsClients\Feed\Types\ContentType;
...
class Request extends Base
{
    ...
    public function __construct($data = null)
    {
        ...
        'MarketplaceIdList' => array('FieldValue' => null, 'FieldType' => IdList::class),
        ...
        'ContentMd5' => array ('FieldValue' => null, 'FieldType' => 'string'),
 	    'ContentType' => array ('FieldValue' => self::$DEFAULT_CONTENT_TYPE, 'FieldType' => ContentType::class),
    ...
    if (!($supplied == self::$DEFAULT_CONTENT_TYPE)) {
    		throw new MWSException(array('Message' =>
     ...
     * 
     * @param IdList|mixed MarketplaceIdList
     * @return void
     * @throws \Exception
     */
