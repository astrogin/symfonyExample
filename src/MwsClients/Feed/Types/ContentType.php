 ...
 *
 */
namespace App\MwsClients\Feed\Types;
/**
...
class ContentType  extends Base {
    ...
    public function isSetParameters() {
    	return is_array($this->fields['Parameters']['FieldValue']) ||
        is_object($this->fields['Parameters']['FieldValue']) ?
            count ($this->fields['Parameters']['FieldValue']) > 0 : false;
    }
