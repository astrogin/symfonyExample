...
use App\Exceptions\MWSException;
use App\MwsClients\Feed\Types\ErrorResponse;
use App\MwsClients\Feed\Types\ResponseHeaderMetadata;
use App\MwsClients\Feed\Types\SubmissionResult\Request as SubmissionResultRequest;
use App\MwsClients\Feed\Types\SubmissionResult\Response as SubmissionResultResponse;
use App\MwsClients\Feed\Types\SubmitFeed\Request as SubmitFeedRequest;
use App\MwsClients\Feed\Types\SubmitFeed\Response as SubmitFeedResponse;
use App\MwsClients\Feed\Types\SubmissionList\Request as SubmissionListRequest;
use App\MwsClients\Feed\Types\SubmissionList\Response as SubmissionListResponse;
...
class Client implements ClientInterface
{
   ...
   * @return SubmitFeedResponse MarketplaceWebService_Model_SubmitFeedResponse
   *
   * @throws MWSException
   */
   ...
   * @return SubmissionResultResponse MarketplaceWebService_Model_GetFeedSubmissionResultResponse
   *
   * @throws MWSException
   */
  public function getFeedSubmissionResult($request)
  {
    if (!$request instanceof SubmissionResultRequest) {
      $request = new SubmissionResultRequest($request);
    }
    $httpResponse = $this->invoke($this->convertGetFeedSubmissionResult($request), $request->getFeedSubmissionResult());
    $response = SubmissionResultResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @return SubmissionListResponse MarketplaceWebService_Model_GetFeedSubmissionListResponse
   *
   * @throws MWSException
   */
  public function getFeedSubmissionList($request)
  {
    if (!$request instanceof SubmissionListRequest) {
      $request = new SubmissionListRequest($request);
    }
    $httpResponse = $this->invoke($this->convertGetFeedSubmissionList($request));
    $response = SubmissionListResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
      ...
      do {
        try {
          ...
          /* Rethrow on deserializer error */
            ...
            throw new MWSException(array('Exception' => $e, 'Message' => $e->getMessage()));
        }
